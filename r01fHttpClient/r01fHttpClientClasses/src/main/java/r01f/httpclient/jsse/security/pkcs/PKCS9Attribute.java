...
import r01f.httpclient.jsse.security.x509.CertificateExtensions;
...
public class PKCS9Attribute implements DerEncoder {
     ...
     * @throws Exception
     */
    public PKCS9Attribute(DerValue derVal) throws Exception {
        ...
        if (index == -1) {
            ...
            throw new Exception("Unsupported PKCS9 attribute: " + oid);
        }
