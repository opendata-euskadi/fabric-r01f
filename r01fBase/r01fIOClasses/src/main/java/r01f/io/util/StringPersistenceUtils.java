...
/////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 * @throws IOException
	 */
	public static void save(final InputStream is,
							final File f) throws IOException {
		StringPersistenceUtils.save(is,
	 ...
	 */
	public static void save(final InputStream is,
							final File f,final Charset outputFileCharset) throws IOException {
		InputStreamReader reader = new InputStreamReader(is,Charset.defaultCharset());
		StringPersistenceUtils.save(reader,
									f,outputFileCharset);
	}
	/**
	 ...
	 * @throws IOException
	 */
	public static void save(final InputStream is,final Charset isCharset,
							final File f) throws IOException {
		StringPersistenceUtils.save(is,isCharset,
									f,Charset.defaultCharset());
	}
	/**
	 * Stores an inputstream into a file
	...
	public static void save(final InputStream is,final Charset isCharset,
							final File f,final Charset outputFileCharset) throws IOException {
		InputStreamReader reader = new InputStreamReader(is,isCharset);
		StringPersistenceUtils.save(reader,
									f,outputFileCharset);
	}
	/**
	 * Stores a String into a file
	 * @param theString the string to be persisted
	 * @param f the file
	 * @throws IOException
	 */
	public static void save(final CharSequence theString,
							final File f) throws IOException {
		StringPersistenceUtils.save(theString,
									f,Charset.defaultCharset());
	}
	/**
	 * Stores a String into a file
	...
	public static void save(final CharSequence theString,
							final File f,final Charset outputFileCharset) throws IOException {
		StringPersistenceUtils.save(new CharSequenceReader(theString),
									f,outputFileCharset);
	} 
	/**
	 ...
	 */
	public static void save(final CharSequence theString,
							final Path filePath,final Charset outputCharset) throws IOException {
		StringPersistenceUtils.save(theString,
									new File(filePath.asString()),outputCharset);
	}  
	/**
	 * Saves a String into a file
	 * @param theString the string to be persisted
	...
	/**
	 * Persist a reader stream into a file
	 ...
	 * @param reader a reader
	 * @param f the output file
	 * @param fileCharset the target file charset
	 * @throws IOException
	 */
	public static void save(final Reader reader,
							final File f,final Charset fileCharset) throws IOException {
		FileOutputStream fos = new FileOutputStream(f);
		Writer writer = new OutputStreamWriter(fos,fileCharset);
